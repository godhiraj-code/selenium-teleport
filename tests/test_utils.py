...
class TestUrlHelpers:
    ...
    def test_is_same_origin(self):
        ...
        assert is_same_origin("https://example.com/path1", "https://example.com/path2") is True

        assert (
            is_same_origin("https://example.com", "http://example.com") is False  # Different scheme
        )
